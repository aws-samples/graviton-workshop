...
# Hot fix: using `alternatives` does not fix the version used by Maven!!
...
# Install and configure CW agent (optional)
...
# Maven build
# aws s3 cp s3://graviton-perf-module/pom-java11.xml vertx-examples/web-examples/pom.xml
